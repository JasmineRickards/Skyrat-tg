...
/obj/machinery/power/smes
	...
	var/input_level = 150 KILO WATTS // amount of power the SMES attempts to charge by
	...
	var/output_level = 100 KILO WATTS // amount of power the SMES attempts to output
